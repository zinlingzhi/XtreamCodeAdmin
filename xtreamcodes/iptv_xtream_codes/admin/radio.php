                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title"><?php if (isset($rStation["id"])) { echo $rStation["stream_display_name"]; } else { echo "Add Radio Station"; } ?></h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            Radio operation was completed successfully.
                        </div>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            The radio station name is already in use, please select another.
                        </div>
                        <?php }
                        ...
                        <div class="card text-xs-center">
                            <div class="table">
                                <table id="datatable" class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="7" class="text-center">Loading station information...</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="stream_display_name">Station Name</label>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="form-group row mb-4 stream-url">
                                                            <label class="col-md-4 col-form-label" for="stream_source">Station URL</label>
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-4 col-form-label" for="stream_icon">Station Logo URL</label>
                                                            <div class="col-md-8">
                                            ...
                                            <div class="tab-pane" id="load-balancing">
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4">
															<label class="col-md-4 col-form-label" for="restart_on_edit"><?php if (isset($rStation["id"])) { ?>Restart on Edit<?php } else { ?>Start Stream Now<?php } ?></label>
															<div class="col-md-2">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    ...
                                                    <li class="next list-inline-item float-right">
                                                        <input name="submit_radio" type="submit" class="btn btn-primary" value="<?php if (isset($rStation["id"])) { echo "Edit"; } else { echo "Add"; } ?>" />
                                                    </li>
                                                </ul>
                                            </div>
                                        </div> <!-- tab-content -->
        ...
        $(document).ready(function() {
            ...
            $("#radio_form").submit(function(e){
                if ($("#stream_display_name").val().length == 0) {
                    e.preventDefault();
                    $.toast("Enter a radio station name.");
                }
